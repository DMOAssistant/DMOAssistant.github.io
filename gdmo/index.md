...
- 推荐登录端：“重氪、传家宝”玩家建议 steam 账号，否则建议官网账号
- 官网账号
  - 优点：
    - 商场道具均可交易、可叠加
    - 充 C 返利 30% 活动，力度较大
  - 缺点：
    - 易发生**盗号**事件，原因不明
    - 银联/支付宝直充容易限额且贵，需要多账号充值。或者用雷蛇金充值，实惠无限额但需等待
    - 平时购买道具没有优惠
- steam 账号
  - 优点：
    - 账号安全性由 steam 进行保障，不易被盗号
    - 游戏商场常年有 80% 折扣，配合 steam 余额实现折上折
    - 保底产物的绑定/非绑定属性与官网账号一致，除 70 抽的保底因子外均可交易，可以将100抽保底因子交易给官网账号使用
  - 缺点：
    - **无法购买限量礼包**。部分可以通过官网端小号购买交易过来，如金卡礼包；有些绑定的礼包买不到就没了，如顽固礼包、随机危机礼包、随机SSS/SSS+因子礼包等
    - 游戏商场内其他道具均不可交易、不可叠加（譬如金红，100券占100背包格子，扫出来的核也无法叠加），商场购物（囤货）体验较差
    - 返利活动似乎只能买限定道具
...
<!-- [弯刀](https://scimitardats.github.io/)：有封号风险，仅建议小号使用 -->
